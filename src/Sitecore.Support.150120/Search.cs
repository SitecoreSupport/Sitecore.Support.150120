            ...
            if (ContentSearchManager.Locator.GetInstance<Sitecore.ContentSearch.Utilities.IContentSearchConfigurationSettings>().ItemBucketsEnabled())
            {
                ...
                if (!base.AbortSearch)
                {
                    ...
                    if (base.RunFacet)
                    {
                        ...
                        {
                            PageNumbers = 1,
                            facets = GetFacetsPipeline.Run(new GetFacetsArgs(base.SearchQuery, base.LocationFilter)),
                            SearchCount = "1",
                            CurrentPage = 1
                        };
                    ...
                    else
                    {
                        ...
                        SitecoreIndexableItem sitecoreIndexableItem = database1.GetItem(base.LocationFilter);
